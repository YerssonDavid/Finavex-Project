...
const newsItems = [
	{
		...
		description:
			"Las acciones tecnológicas suben un 5% esta semana impulsadas por resultados positivos.",
		icon: TrendingUp,
	...
	},
	{
		...
		description:
			"Los índices de inflación muestran un incremento del 0.3% respecto al mes anterior.",
		icon: AlertTriangle,
	...
	},
	{
		...
		description:
			"Descubre cómo nuestra IA puede ayudarte a ahorrar más cada mes automáticamente.",
		icon: Sparkles,
	...
	},
	{
		...
		description:
			"Bitcoin y Ethereum experimentan fluctuaciones significativas en las últimas 24 horas.",
		icon: TrendingUp,
